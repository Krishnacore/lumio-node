...
use lumio_config::{config::StorageServiceConfig, network_id::PeerNetworkId};
use lumio_logger::{debug, sample, sample::SampleRate, trace, warn};
use lumio_network::protocols::wire::handshake::v1::ProtocolId;
...
impl<T: StorageReaderInterface> Handler<T> {
    ...
    ) -> lumio_storage_service_types::Result<StorageServiceResponse> {
    ...
    pub(crate) fn send_response(
        &self,
        request: StorageServiceRequest,
        response: lumio_storage_service_types::Result<StorageServiceResponse>,
        response_sender: ResponseSender,
    ) {
    ...
    fn process_cachable_request(
        ...
        peer_network_id: &PeerNetworkId,
        request: &StorageServiceRequest,
    ) -> lumio_storage_service_types::Result<StorageServiceResponse, Error> {
    ...
    ) -> lumio_storage_service_types::Result<DataResponse, Error> {
...
fn log_storage_response(
    ...
    storage_response: &lumio_storage_service_types::Result<
