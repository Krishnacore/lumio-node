...
pub fn new_storage_service_notifier_listener_pair(
    ...
    let (notification_sender, notification_receiver) = lumio_channel::new(
        QueueStyle::LIFO,
...
pub struct StorageServiceNotifier {
    notification_sender: lumio_channel::Sender<(), StorageServiceCommitNotification>,
}
...
pub struct StorageServiceNotificationListener {
    notification_receiver: lumio_channel::Receiver<(), StorageServiceCommitNotification>,
}
