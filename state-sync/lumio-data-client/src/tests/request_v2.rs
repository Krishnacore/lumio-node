...
use crate::{
    ...
    interface::{LumioDataClientInterface, SubscriptionRequestMetadata},
    priority::PeerPriority,
    tests::{mock::MockNetwork, utils},
};
use lumio_config::{config::LumioDataClientConfig, network_id::NetworkId};
...
fn create_lumio_data_client(use_request_v2: bool) -> LumioDataClientConfig {
    LumioDataClientConfig {
...
fn create_client_with_peer(use_request_v2: bool) -> (MockNetwork, LumioDataClient, NetworkId) {
    ...
    let data_client_config = create_lumio_data_client(use_request_v2);
