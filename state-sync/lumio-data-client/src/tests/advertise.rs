...
use lumio_config::{config::LumioDataClientConfig, network_id::PeerNetworkId};
...
use lumio_types::transaction::{TransactionListWithProofV2, Version};
...
async fn request_works_only_when_data_available() {
    ...
    for peer_priority in PeerPriority::get_all_ordered_priorities() {
        ...
        // Create the lumio data client config
