...
use lumio_config::{
    config::{LumioDataClientConfig, LumioDataMultiFetchConfig, LumioLatencyFilteringConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use lumio_storage_service_types::requests::{DataRequest, StorageServiceRequest};
...
async fn request_latency_filtering() {
    ...
    let data_client_config = LumioDataClientConfig {
        ...
        latency_filtering_config: LumioLatencyFilteringConfig {
