...
use lumio_storage_service_types::{responses::TransactionOrOutputListWithProofV2, Epoch};
use lumio_types::{
...
/// The API offered by the Lumio Data Client.
#[async_trait]
pub trait LumioDataClientInterface {
...
/// A response error that users of the Lumio Data Client can use to notify
