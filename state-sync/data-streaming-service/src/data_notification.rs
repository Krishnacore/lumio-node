...
use lumio_data_client::interface::{Response, ResponsePayload};
use lumio_types::{
...
/// A request that has been sent to the Lumio data client.
#[derive(Clone, Debug, Eq, PartialEq)]
...
pub struct PendingClientResponse {
    ...
    pub client_response: Option<Result<Response<ResponsePayload>, lumio_data_client::error::Error>>,
}
...
impl PendingClientResponse {
    ...
    pub fn new_with_response(
        ...
        client_response: Result<Response<ResponsePayload>, lumio_data_client::error::Error>,
    ) -> Self {
        Self {
            client_request,
