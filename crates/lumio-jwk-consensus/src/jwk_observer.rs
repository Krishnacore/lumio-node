...
use lumio_jwk_utils::{fetch_jwks_from_jwks_uri, fetch_jwks_uri_from_openid_config};
use lumio_logger::{debug, info};
use lumio_types::jwks::{jwk::JWK, Issuer};
...
impl JWKObserver {
    pub fn spawn(
        ...
        observation_tx: lumio_channel::Sender<(), (Issuer, Vec<JWK>)>,
    ) -> Self {
