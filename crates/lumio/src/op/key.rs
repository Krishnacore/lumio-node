...
use lumio_config::config::{Peer, PeerRole};
use lumio_crypto::{
...
use lumio_types::account_address::{
...
/// with all key types used on the Lumio blockchain.
...
///
/// ```bash
/// lumio key extract-public-key --private-key-file ./path-to-key --output-file ./path-to-output --key-type bls12381
/// ```
#[derive(Debug, Parser)]
