...
use lumio_gas_profiling::FrameName;
use lumio_move_debugger::lumio_debugger::LumioDebugger;
use lumio_types::transaction::{AuxiliaryInfo, PersistedAuxiliaryInfo, SignedTransaction};
...
use lumio_vm_types::{
    module_and_script_storage::AsLumioCodeStorage, output::VMOutput, resolver::StateStorageView,
};
use move_core_types::vm_status::VMStatus;
use std::{path::Path, time::Instant};

pub fn run_transaction_using_debugger(
    debugger: &LumioDebugger,
    version: u64,
