...
use lumio_indexer_grpc_server_framework::setup_logging;
...
pub struct RunLocalnet {
    ...
    ///
    /// Defaults to .lumio/testnet
    #[clap(long, value_parser)]
    test_dir: Option<PathBuf>,

    /// Clean the state and start with a new chain at genesis
    ///
    /// This will wipe the lumiodb in `--test-dir` to remove any incompatible changes, and start
