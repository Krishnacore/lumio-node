# Lumio CLI Development Guide

This is a list of design decisions and guidelines for adding commands to the Lumio CLI.
...
#[derive(Parser)]
#[clap(name = "lumio", author, version, propagate_version = true, styles = lumio_cli_common::lumio_cli_style())]
pub enum Tool {
    #[clap(subcommand)]
...
```bash
lumio move compile --save-metadata
```
