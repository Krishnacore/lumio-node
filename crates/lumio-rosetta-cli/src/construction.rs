...
use lumio::common::types::{EncodingOptions, PrivateKeyInputOptions, ProfileOptions};
use lumio_logger::info;
use lumio_rosetta::types::{Currency, TransactionIdentifier};
...
pub struct CreateAccountCommand {
    ...
    #[clap(long, value_parser = lumio::common::types::load_account_arg)]
