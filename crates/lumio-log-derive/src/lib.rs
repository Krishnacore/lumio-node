...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::lumio_logger::Value::from_serde };
    let from_display = quote! { ::lumio_logger::Value::from_display };
    let from_debug = quote! { ::lumio_logger::Value::from_debug };
    let key_new = quote! { ::lumio_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::lumio_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::lumio_logger::Visitor) {
                #(#visits)*
            }
        }
    };
