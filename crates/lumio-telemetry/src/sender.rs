...
use lumio_config::config::{NodeConfig, RoleType};
use lumio_crypto::{
...
use lumio_telemetry_service::types::{
...
mod tests {
    ...
    use super::*;
    use crate::metrics::{LUMIO_TELEMETRY_SERVICE_FAILURE, LUMIO_TELEMETRY_SERVICE_SUCCESS};
