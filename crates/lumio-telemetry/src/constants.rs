...
pub(crate) const ENV_LUMIO_DISABLE_TELEMETRY: &str = "LUMIO_DISABLE_TELEMETRY";
pub(crate) const ENV_LUMIO_FORCE_ENABLE_TELEMETRY: &str = "LUMIO_FORCE_ENABLE_TELEMETRY";
pub(crate) const ENV_LUMIO_DISABLE_TELEMETRY_PUSH_METRICS: &str =
    "LUMIO_DISABLE_TELEMETRY_PUSH_METRICS";
pub(crate) const ENV_LUMIO_DISABLE_TELEMETRY_PUSH_LOGS: &str = "LUMIO_DISABLE_TELEMETRY_PUSH_LOGS";
pub(crate) const ENV_LUMIO_DISABLE_TELEMETRY_PUSH_EVENTS: &str =
    "LUMIO_DISABLE_TELEMETRY_PUSH_EVENTS";
pub(crate) const ENV_LUMIO_DISABLE_PROMETHEUS_NODE_METRICS: &str =
    "LUMIO_DISABLE_PROMETHEUS_NODE_METRICS";
pub(crate) const ENV_LUMIO_DISABLE_LOG_ENV_POLLING: &str = "LUMIO_DISABLE_LOG_ENV_POLLING";
...
pub(crate) const LUMIO_GA_MEASUREMENT_ID: &str = "G-ZX4L6WPCFZ";
pub(crate) const LUMIO_GA_API_SECRET: &str = "ArtslKPTTjeiMi1n-IR39g";
...
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.lumiolabs.com";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.lumiolabs.com";
