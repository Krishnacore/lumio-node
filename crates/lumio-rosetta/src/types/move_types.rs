...
use lumio_types::event::EventHandle;
use serde::{Deserialize, Serialize};

pub const ACCOUNT_MODULE: &str = "account";
pub const LUMIO_ACCOUNT_MODULE: &str = "lumio_account";
pub const LUMIO_COIN_MODULE: &str = "lumio_coin";
...
pub const LUMIO_COIN_RESOURCE: &str = "LumioCoin";
