...
use lumio_sdk::{move_types::language_storage::TypeTag, transaction_builder::TransactionFactory};
use lumio_types::{
...
async fn construction_derive(
    ...
    // Lumio Ed25519 authentication scheme
    let public_key: Ed25519PublicKey =
...
///
/// Only the original Ed25519 accounts on Lumio are supported
///
        ...
        TransactionPayload::EntryFunction(inner) => {
            ...
            match (
                *module.address(),
                ...
                (AccountAddress::ONE, LUMIO_ACCOUNT_MODULE, CREATE_ACCOUNT_FUNCTION) => {
...
/// Parses 0x1::lumio_account::create(auth_key: address)
...
/// Parses 0x1::lumio_account::transfer(receiver: address, amount: u64)
...
/// or 0x1::lumio_account::transfer_fungible_assets(metadata: address, receiver: address, amount: u64)
