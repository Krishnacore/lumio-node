...
pub struct RosettaContext {
    ...
    rest_client: Option<Arc<lumio_rest_client::Client>>,
...
impl RosettaContext {
    ...
    fn rest_client(&self) -> ApiResult<Arc<lumio_rest_client::Client>> {
...
pub fn bootstrap(
    ...
    rest_client: Option<lumio_rest_client::Client>,
    supported_currencies: HashSet<Currency>,
) -> anyhow::Result<tokio::runtime::Runtime> {
    let runtime = lumio_runtimes::spawn_named_runtime("rosetta".into(), None);
