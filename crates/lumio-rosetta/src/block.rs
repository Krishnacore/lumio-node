...
async fn build_block(
    ...
    block: lumio_rest_client::lumio_api_types::BcsBlock,
    chain_id: ChainId,
...
async fn get_block_by_index(
    ...
    BlockIdentifier,
    lumio_rest_client::lumio_api_types::BcsBlock,
)> {
...
pub struct BlockRetriever {
    page_size: u16,
    rest_client: Arc<lumio_rest_client::Client>,
}

impl BlockRetriever {
    pub fn new(page_size: u16, rest_client: Arc<lumio_rest_client::Client>) -> Self {
        BlockRetriever {
            page_size,
            rest_client,
        }
    ...
    ) -> ApiResult<lumio_rest_client::lumio_api_types::BcsBlock> {
