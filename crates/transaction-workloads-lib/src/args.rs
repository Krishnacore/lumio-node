...
impl TransactionTypeArg {
    ...
    pub fn materialize(
        ...
        match &self {
            ...
            TransactionTypeArg::LUMTransferWithPermissionedSigner => {
                call_custom_module(EntryPoints::LUMTransferWithPermissionedSigner)
            },
            TransactionTypeArg::LUMTransferWithMasterSigner => {
                call_custom_module(EntryPoints::LUMTransferWithMasterSigner)
            },
