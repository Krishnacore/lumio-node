...
use lumio_rest_client::{lumio_api_types, LumioBaseUrl, Client as RestClient};
use reqwest::Url;
use std::fmt;

// Custom header value to identify the client
const X_LUMIO_CLIENT_VALUE: &str = "lumio-transaction-emitter";
...
impl Instance {
    ...
    pub fn rest_client(&self) -> RestClient {
        let client = RestClient::builder(LumioBaseUrl::Custom(self.api_url()))
