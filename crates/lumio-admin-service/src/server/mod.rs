...
use lumio_config::config::{AdminServiceConfig, AuthenticationConfig, NodeConfig};
use lumio_consensus::{
...
use lumio_system_utils::utils::reply_with_status;
#[cfg(target_os = "linux")]
use lumio_system_utils::{
...
pub struct Context {
    ...
    lumio_db: RwLock<Option<Arc<DbReaderWriter>>>,
...
impl Context {
    fn set_lumio_db(&self, lumio_db: Arc<DbReaderWriter>) {
        *self.lumio_db.write() = Some(lumio_db);
    }
...
impl AdminService {
    ...
    pub fn new(node_config: &NodeConfig) -> Self {
        ...
        let runtime = lumio_runtimes::spawn_named_runtime("admin".into(), None);
    ...
    pub fn set_lumio_db(&self, lumio_db: Arc<DbReaderWriter>) {
        self.context.set_lumio_db(lumio_db)
    }
