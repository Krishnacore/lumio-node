...
//! see the [coding guidelines](https://lumio.dev/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use lumio_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::lumio_logger::{
    LumioData as Logger, LumioDataBuilder, LoggerFilterUpdater, Writer, CHANNEL_SIZE,
};
pub use lumio_log_derive::Schema;
pub use event::Event;
