...
pub fn lumio_cli_style() -> clap::builder::Styles {
    ...
    Styles::styled()
        ...
        // To test: `lumio help` and `lumio account create`
        ...
        // To test: `lumio account create`
        .error(Style::new().fg_color(Some(Ansi(AnsiColor::BrightRed))))
        // Placeholder eg. <ACCOUNT>
        // To test: `lumio account create` or `lumio account create --help`
        ...
        // To test: `lumio account create --account not-a-number`
