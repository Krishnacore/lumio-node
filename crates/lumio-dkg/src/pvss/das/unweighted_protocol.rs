...
use anyhow::bail;
use lumio_crypto::{bls12381, CryptoMaterialError, Genesis, SigningKey, ValidCryptoMaterial};
...
const DAS_PVSS_FIAT_SHAMIR_DST: &[u8; 30] = b"LUMIO_DAS_PVSS_FIAT_SHAMIR_DST";
