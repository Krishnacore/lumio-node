...
id: crypto
title: Crypto
custom_edit_url: https://github.com/lumio-labs/lumio-core/edit/main/crypto/crypto/README.md
---

The crypto component hosts all the implementations of cryptographic primitives we use in Lumio: hashing, signatures, multisignatures, aggregate signatures, and key derivation/generation.
...
Lumio makes use of several cryptographic algorithms:
