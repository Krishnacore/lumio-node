...
//! ```
//! use std::iter::zip;
//! use lumio_crypto::test_utils::{KeyPair, TestLumioCrypto};
//! use lumio_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use lumio_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use lumio_crypto::bls12381::ProofOfPossession;
//! use lumio_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/lumio-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestLumioCrypto("test".to_owned());
...
//! use lumio_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use lumio_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use lumio_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use lumio_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use lumio_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/lumio-crypto/`
...
//! // signature on TestLumioCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use lumio_crypto::test_utils::KeyPair;
//! use lumio_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use lumio_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use lumio_crypto::bls12381::ProofOfPossession;
//! use lumio_crypto_derive::{CryptoHasher, BCSCryptoHash};
