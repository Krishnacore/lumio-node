...
use crate::{
    ...
    test_utils::{TestLumioCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestLumioCrypto> = Lazy::new(|| TestLumioCrypto("Test Message".to_string()));
fn message() -> &'static TestLumioCrypto {
    &MESSAGE
}
