...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestLumioCrypto)> {
    (
...
pub struct TestLumioCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestLumioCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestLumioCryptoHasher {
    #[inline]
    fn clone(&self) -> TestLumioCryptoHasher {
        match *self {
            TestLumioCryptoHasher(ref __self_0_0) => {
                TestLumioCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            },
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestLumioCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestLumioCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestLumioCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestLumioCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestLumioCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestLumioCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestLumioCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestLumioCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestLumioCrypto {
    type Hasher = TestLumioCryptoHasher;

    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestLumioCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestLumioCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestLumioCrypto> {
    (String::arbitrary()).prop_map(TestLumioCrypto).no_shrink()
}
