...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"lumio_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"lumio_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"lumio_framework::vesting";
...
// See this issue for potential improvements: https://github.com/lumio-labs/lumio-core/issues/3960
...
mod hasher {
    #[derive(serde::Deserialize, lumio_crypto_derive::CryptoHasher)]
