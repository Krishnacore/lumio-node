...
pub fn is_lumio_governance_create_proposal_event(event_type: &str) -> bool {
    event_type == "0x1::lumio_governance::CreateProposal"
        || event_type == "0x1::lumio_governance::CreateProposalEvent"
}
