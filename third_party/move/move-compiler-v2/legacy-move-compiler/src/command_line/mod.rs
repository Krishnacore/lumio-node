...
pub const WARN_OF_DEPRECATION_USE_IN_LUMIO_LIBS: &str = "WARN_OF_DEPRECATION_USE_IN_LUMIO_LIBS";
pub const WARN_OF_DEPRECATION_USE_IN_LUMIO_LIBS_FLAG: &str = "Wdeprecation-lumio";
