...
use lumio_rest_client::Client as LumioRestClient;
use lumio_sdk::types::network_address::NetworkAddress;
...
impl NodeAddress {
    ...
    pub fn get_api_client(&self, timeout: Duration) -> Result<LumioRestClient> {
        ...
        Ok(LumioRestClient::from((client, self.get_api_url()?)))
    }
