...
/// Example:
/// ```
/// use lumio_transaction_filter::UserTransactionFilterBuilder;
///
...
impl From<lumio_protos::indexer::v1::UserTransactionFilter> for UserTransactionFilter {
    fn from(proto_filter: lumio_protos::indexer::v1::UserTransactionFilter) -> Self {
        Self {
...
impl From<UserTransactionFilter> for lumio_protos::indexer::v1::UserTransactionFilter {
...
/// Example:
/// ```
/// use lumio_transaction_filter::EntryFunctionFilterBuilder;
///
...
impl From<lumio_protos::indexer::v1::EntryFunctionFilter> for EntryFunctionFilter {
    fn from(proto_filter: lumio_protos::indexer::v1::EntryFunctionFilter) -> Self {
        Self {
...
impl From<EntryFunctionFilter> for lumio_protos::indexer::v1::EntryFunctionFilter {
...
/// Example:
/// ```
/// use lumio_transaction_filter::{EntryFunctionFilterBuilder, UserTransactionPayloadFilterBuilder};
///
...
impl From<lumio_protos::indexer::v1::UserTransactionPayloadFilter>
    for UserTransactionPayloadFilter
{
    fn from(proto_filter: lumio_protos::indexer::v1::UserTransactionPayloadFilter) -> Self {
        Self {
...
impl From<UserTransactionPayloadFilter>
    for lumio_protos::indexer::v1::UserTransactionPayloadFilter
{
