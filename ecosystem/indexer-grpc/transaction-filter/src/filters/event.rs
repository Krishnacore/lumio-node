...
use anyhow::Error;
use lumio_protos::transaction::v1::{move_type::Content, Event};
...
/// Example:
/// ```
/// use lumio_transaction_filter::{EventFilterBuilder, MoveStructTagFilterBuilder};
///
...
impl From<lumio_protos::indexer::v1::EventFilter> for EventFilter {
    fn from(proto_filter: lumio_protos::indexer::v1::EventFilter) -> Self {
        Self {
...
impl From<EventFilter> for lumio_protos::indexer::v1::EventFilter {
