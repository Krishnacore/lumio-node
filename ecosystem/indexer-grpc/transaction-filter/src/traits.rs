...
mod test {
    ...
    fn test_error_prop() {
        ...
        assert_eq!(error.to_string(), "Filter Error: This is a test error!\nTrace Path:\nlumio_transaction_filter::traits::test::InnerStruct:   {\"a\":\"test\"}\ncore::option::Option<lumio_transaction_filter::traits::test::InnerStruct>:   {\"a\":\"test\"}\nlumio_transaction_filter::traits::test::OuterStruct:   {\"inner\":{\"a\":\"test\"}}");
    }
}
