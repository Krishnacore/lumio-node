...
use lumio_indexer_grpc_utils::{
    ...
    constants::{
        ...
        MESSAGE_SIZE_LIMIT, REQUEST_HEADER_LUMIO_APPLICATION_NAME, REQUEST_HEADER_LUMIO_EMAIL,
        REQUEST_HEADER_LUMIO_IDENTIFIER, REQUEST_HEADER_LUMIO_IDENTIFIER_TYPE,
    },
...
use lumio_transaction_filter::{BooleanTransactionFilter, Filterable};
use futures::Stream;
use prost::Message;
use redis::Client;
use std::{
...
const RESPONSE_HEADER_LUMIO_CONNECTION_ID_HEADER: &str = "x-lumio-connection-id";
...
impl RawData for RawDataServerWrapper {
    ...
    async fn get_transactions(
        ...
        response.metadata_mut().insert(
            RESPONSE_HEADER_LUMIO_CONNECTION_ID_HEADER,
...
fn get_request_metadata(
    ...
    let request_metadata_pairs = vec![
        (
            ...
            REQUEST_HEADER_LUMIO_IDENTIFIER_TYPE,
        ),
        ("request_identifier", REQUEST_HEADER_LUMIO_IDENTIFIER),
        ("request_email", REQUEST_HEADER_LUMIO_EMAIL),
        (
            "request_application_name",
            REQUEST_HEADER_LUMIO_APPLICATION_NAME,
        ),
