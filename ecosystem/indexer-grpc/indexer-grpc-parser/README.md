# All processors are migrated to [processor repo](https://github.com/lumio-labs/lumio-indexer-processors)
...
## Tutorial
### Prerequisite
* A running PostgreSQL instance, with a valid database. More tutorial can be found [here](https://github.com/lumio-labs/lumio-core/tree/main/crates/indexer#postgres)
...
### Use a custom parser
* Check our [indexer processors](https://github.com/lumio-labs/lumio-indexer-processors)! 
