# Lumio Indexer GRPC on Fullnode
...
* Run fullnode `cargo run -p lumio-node --release -- -f ./fullnode.yaml`

### 2) Test with GCURL
* Install grpcurl (https://github.com/fullstorydev/grpcurl#installation)
* From the lumio-core (base folder), test with grpcurl: `grpcurl  -max-msg-sz 10000000 -d '{ "starting_version": 0 }' -import-path crates/lumio-protos/proto -proto lumio/internal/fullnode/v1/fullnode_data.proto  -plaintext 127.0.0.1:50051 lumio.internal.fullnode.v1.FullnodeData/GetTransactionsFromNode`
