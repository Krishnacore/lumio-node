...
use lumio_event_notifications::{DbBackedOnChainConfig, EventSubscriptionService};
use lumio_logger::prelude::*;
use lumio_netcore::transport::tcp::TCPBufferCfg;
use lumio_network::{
...
use lumio_network_discovery::DiscoveryChangeListener;
use lumio_time_service::TimeService;
use lumio_types::{chain_id::ChainId, network_address::NetworkAddress};
...
impl NetworkBuilder {
    ...
    pub fn conn_mgr_reqs_tx(&self) -> Option<lumio_channels::Sender<ConnectivityRequest>> {
