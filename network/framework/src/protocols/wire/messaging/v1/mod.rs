...
//! This module defines the LumioNet v1 message types, how they are
...
//!
//! The [LumioNet Specification](https://github.com/lumio-labs/lumio-core/blob/main/documentation/specifications/network/messaging-v1.md)
