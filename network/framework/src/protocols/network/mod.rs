...
//! Convenience Network API for Lumio
...
/// Configuration needed for the client side of LumioNet applications
#[derive(Clone)]
...
/// Configuration needed for the service side of LumioNet applications
#[derive(Clone)]
pub struct NetworkServiceConfig {
    ...
    pub inbound_queue_config: lumio_channel::Config,
}
...
impl NetworkServiceConfig {
    pub fn new(
        direct_send_protocols_and_preferences: Vec<ProtocolId>,
        rpc_protocols_and_preferences: Vec<ProtocolId>,
        inbound_queue_config: lumio_channel::Config,
    ) -> Self {
        Self {
            direct_send_protocols_and_preferences,
            rpc_protocols_and_preferences,
...
/// Configuration needed for LumioNet applications to register with the network
...
pub trait NewNetworkEvents {
    fn new(
        peer_mgr_notifs_rx: lumio_channel::Receiver<(PeerId, ProtocolId), ReceivedMessage>,
...
/// a thin wrapper on `lumio_channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>`,
