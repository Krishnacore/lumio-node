...
id: network
title: Network
custom_edit_url: https://github.com/lumio-labs/lumio-core/edit/main/network/README.md
---

## Overview

For more detailed info, see the [LumioNet Specification](../documentation/specifications/network/README.md).

LumioNet is the primary protocol for communication between any two nodes in the
Lumio ecosystem. It is specifically designed to facilitate the consensus, shared
mempool, and state sync protocols. LumioNet tries to maintain at-most one connection
...
+ [`LumioTransport`] &mdash; A secure, reliable transport. It uses [NoiseIK] over
TCP to negotiate an encrypted and authenticated connection between peers.
The LumioNet version and any Lumio-specific application protocols are negotiated
afterward using the [LumioNet Handshake Protocol].
...
## How is this module organized?
    ...
    └── src
        ...
        │   └── wire               # Protocol for LumioNet handshakes and messaging
...
[`LumioNet Handshake Protocol`]: ../specifications/network/handshake-v1.md
[`ValidatorSet`]: ../types/src/on_chain_config/validator_set.rs
[`LumioTransport`]: ./src/transport/mod.rs
