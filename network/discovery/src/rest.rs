...
use lumio_config::{config::PeerSet, network_id::NetworkContext};
use lumio_logger::info;
use lumio_time_service::{Interval, TimeService, TimeServiceTrait};
use lumio_types::{account_address::AccountAddress, on_chain_config::ValidatorSet};
...
impl RestStream {
    pub(crate) fn new(
        ...
        RestStream {
            network_context,
            rest_client: lumio_rest_client::Client::new(rest_url),
