        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.internal.fullnode.v1.FullnodeData/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("lumio.internal.fullnode.v1.FullnodeData", "Ping"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.internal.fullnode.v1.FullnodeData/GetTransactionsFromNode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod fullnode_data_server {
    ...
    impl<T: FullnodeData> tonic::server::NamedService for FullnodeDataServer<T> {
        const NAME: &'static str = "lumio.internal.fullnode.v1.FullnodeData";
    }
}
