...
*/
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.indexer.v1.RawData/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lumio.indexer.v1.RawData", "GetTransactions"));
...
*/
    ...
    impl<T: RawData> tonic::server::NamedService for RawDataServer<T> {
        const NAME: &'static str = "lumio.indexer.v1.RawData";
    }
}
/// Generated client implementations.
pub mod grpc_manager_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.indexer.v1.GrpcManager/Heartbeat",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lumio.indexer.v1.GrpcManager", "Heartbeat"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.indexer.v1.GrpcManager/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("lumio.indexer.v1.GrpcManager", "GetTransactions"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.indexer.v1.GrpcManager/GetDataServiceForRequest",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "lumio.indexer.v1.GrpcManager",
...
pub mod grpc_manager_server {
    ...
    impl<T: GrpcManager> tonic::server::NamedService for GrpcManagerServer<T> {
        const NAME: &'static str = "lumio.indexer.v1.GrpcManager";
    }
}
/// Generated client implementations.
pub mod data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.indexer.v1.DataService/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lumio.indexer.v1.DataService", "Ping"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_transactions(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lumio.indexer.v1.DataService/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("lumio.indexer.v1.DataService", "GetTransactions"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
    }
...
pub mod data_service_server {
    ...
    impl<T: DataService> tonic::server::NamedService for DataServiceServer<T> {
        const NAME: &'static str = "lumio.indexer.v1.DataService";
    }
}
