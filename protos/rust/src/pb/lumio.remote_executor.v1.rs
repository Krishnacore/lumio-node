...
/// Encoded file descriptor set for the `lumio.remote_executor.v1` package
...
include!("lumio.remote_executor.v1.serde.rs");
include!("lumio.remote_executor.v1.tonic.rs");
