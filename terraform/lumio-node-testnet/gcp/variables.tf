...
variable "chain_id" {
  description = "Lumio chain ID"
  type        = string
  default     = "TESTING"
}

variable "chain_name" {
  description = "Lumio chain name"
  type        = string
  default     = "testnet"
}

variable "image_tag" {
  description = "Docker image tag for Lumio node"
  type        = string
  default     = "devnet"
}
...
variable "helm_release_name_override" {
  description = "If set, overrides the name of the lumio-node helm chart"
  type        = string
  default     = ""
}
