Lumio Fullnodes VULTR (https://www.vultr.com/) Deployment
==============================
...
2. Clone the lumio-core repo and go to the terraform vultr folder.

         $ git clone https://github.com/lumio-labs/lumio-core.git

         $ cd lumio-core/terraform/fullnode/vultr
...
11. To verify the correctness of your FullNode, as outlined in the documentation (https://lumio.dev/tutorials/run-a-fullnode/#verify-the-correctness-of-your-fullnode), you will need to set up a port-forwarding mechanism directly to the lumio pod in one ssh terminal and test it in another ssh terminal
