...
use lumio_types::{keyless::OpenIdSig, transaction::authenticator::EphemeralPublicKey};
...
pub async fn run_client_example(
    ...
    utils::print(
        "Starting the example client that interacts with the Lumio OIDB Pepper Service.",
        true,
    );
