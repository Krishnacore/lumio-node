...
use lumio_keyless_pepper_common::{
    account_recovery_db::AccountRecoveryDbEntry,
    jwt::Claims,
    vuf::{
        self,
        bls12381_g1_bls::PinkasPepper,
        slip_10::{get_lumio_derivation_path, ExtendedPepper},
        VUF,
    },
...
async fn process_common(
    ...
    let checked_derivation_path = get_lumio_derivation_path(&derivation_path)
    ...
    let claims = lumio_keyless_pepper_common::jwt::parse(jwt.as_str())
