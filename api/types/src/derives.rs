...
//! documentation within `crates/lumio-openapi`.
//!
...
//! <https://github.com/lumio-labs/lumio-core/issues/2319>
...
// https://github.com/lumio-labs/lumio-core/pull/2703
...
use lumio_openapi::{impl_poem_parameter, impl_poem_type};
use indoc::indoc;
use serde_json::json;
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            A hex encoded 32 byte Lumio account address.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::lumio_coin::LumioCoin".to_string()
        )),
        format = Some("hex"),
        description = Some(indoc! {"
            A hex encoded 32 byte Lumio account address or a struct tag.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::lumio_coin::transfer".to_string()
        )),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    "string",
    (
        example = Some(serde_json::Value::String("0x1::lumio_coin".to_string())),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::coin::CoinStore<0x1::lumio_coin::LumioCoin>".to_string()
        )),
        ...
        Examples:
          * `0x1::coin::CoinStore<0x1::lumio_coin::LumioCoin>`
          * `0x1::account::Account`
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            ...
            Move `address` type value (32 byte Lumio account address) is serialized into a HexEncodedBytes string.
            For example:
              - `0x1`
            ...
            **Special serialization for Move stdlib types**:
              - [0x1::string::String](https://github.com/lumio-labs/lumio-core/blob/main/third_party/move/move-stdlib/docs/ascii.md)
        ...
        description = Some(indoc! {"
            String representation of an on-chain Move type tag that is exposed in transaction payload.
                ...
                Vector type value examples:
                  - `vector<u8>`
                  - `vector<vector<u64>>`
                  - `vector<0x1::coin::CoinStore<0x1::lumio_coin::LumioCoin>>`
