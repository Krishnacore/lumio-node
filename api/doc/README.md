...
## Overview
Lumio Node API v1 provides a RESTful interface for interacting with Lumio blockchain nodes. The API enables users to retrieve blockchain information, submit transactions, and query account states.
...
## Getting Started
1. Ensure you have an Lumio node running
...
## Support
- [GitHub Issues](https://github.com/lumio-labs/lumio-core/issues)
- [Discord](https://discord.gg/lumionetwork)
- [Lumio Documentation](https://lumio.dev)
