...
use lumio_api_types::{mime_types::JSON, LumioError, LumioErrorCode};
use poem::{
...
/// be a JSON representation of LumioError. For our own code, this is exactly
...
fn build_error_response(error_string: String) -> Response {
    Json(LumioError::new_with_error_code(
        error_string,
