...
use lumio_mempool_notifications::{self, MempoolNotifier};
use lumio_network::{
    application::{
...
use lumio_storage_interface::{mock::MockDbReaderWriter, DbReaderWriter};
use lumio_types::{
    mempool_status::MempoolStatusCode,
    on_chain_config::{InMemoryOnChainConfig, OnChainConfigPayload},
    transaction::{ReplayProtector, SignedTransaction},
};
use lumio_vm_validator::{
...
impl MockSharedMempool {
    ...
    pub fn start<V: TransactionValidation + 'static>(
        ...
        let (_network_notifs_tx, network_notifs_rx) = lumio_channel::new(QueueStyle::FIFO, 8, None);
