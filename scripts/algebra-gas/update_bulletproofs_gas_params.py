...
def main(gas_per_ns):
    path = Path('lumio-move/lumio-gas/src/lumio_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs module in `lumio-move/lumio-gas/src/lumio_framework.rs`.')
