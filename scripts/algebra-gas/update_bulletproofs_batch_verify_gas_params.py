...
# so this should be larger than `LATEST_GAS_FEATURE_VERSION` in `lumio-move/lumio-gas/src/gas_meter.rs`.
...
def main(gas_per_ns):
    path = Path('lumio-move/lumio-gas-schedule/src/gas_schedule/lumio_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs batch verification in `lumio-move/lumio-gas-schedule/src/gas_schedule/lumio_framework.rs`.')
