...
(
  ...
  echo "See https://github.com/lumio-labs/lumio-core-private/tree/main/protos/README.md if you're having troubles"
  cd protos/
...
(
  ...
  cargo run -p generate-format -- --corpus lumio --record
...
(
  echo
  echo "Regenerating Lumio Node APIs (in `pwd`)"
  # Lumio Node API
...
echo " 1. Check out https://github.com/lumio-labs/lumio-core/blob/main/testsuite/generate-format/README.md"
