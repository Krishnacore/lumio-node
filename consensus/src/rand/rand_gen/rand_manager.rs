...
use lumio_config::config::ReliableBroadcastConfig;
use lumio_consensus_types::common::{Author, Round};
use lumio_infallible::Mutex;
use lumio_logger::{error, info, spawn_named, trace, warn};
...
impl<S: TShare, D: TAugmentedData> RandManager<S, D> {
    ...
    async fn verification_task(
        epoch_state: Arc<EpochState>,
        mut incoming_rpc_request: lumio_channel::Receiver<Author, IncomingRandGenRequest>,
    ...
    pub async fn start(
        ...
        incoming_rpc_request: lumio_channel::Receiver<Author, IncomingRandGenRequest>,
