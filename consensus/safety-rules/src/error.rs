...
impl From<lumio_secure_storage::Error> for Error {
    fn from(error: lumio_secure_storage::Error) -> Self {
        match error {
            lumio_secure_storage::Error::PermissionDenied => {
            ...
            lumio_secure_storage::Error::KeyVersionNotFound(_, _)
            | lumio_secure_storage::Error::KeyNotSet(_) => {
