...
use lumio_vm::{LumioVM, VMBlockExecutor};
...
pub struct LumioVMParallelUncoordinatedBlockExecutor;

impl VMBlockExecutor for LumioVMParallelUncoordinatedBlockExecutor {
    fn new() -> Self {
        Self
    }
