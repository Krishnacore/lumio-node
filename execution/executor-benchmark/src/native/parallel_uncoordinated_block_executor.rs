...
enum CachedResource {
    ...
    AptCoinStore(CoinStoreResource<LumioCoinType>),
    AptCoinInfo(CoinInfoResource<LumioCoinType>),
...
impl NativeValueCacheRawTransactionExecutor {
    ...
    fn update_coin_balance(
        ...
        let coin_store_key = self.db_util.new_state_key_lumio_coin(&account);
        let mut exists = true;
