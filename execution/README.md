...
id: executor
title: Executor
custom_edit_url: https://github.com/lumio-labs/lumio-core/edit/main/executor/README.md
---


## Overview

The Lumio Blockchain is a replicated state machine. Each validator is a replica
...
in the Lumio Node config file for it to work, but can leave other entries
default by not specifying them.

```yaml
execution:
    # see https://github.com/lumio-labs/lumio-core/blob/main/config/src/config/test_data/public_full_node.yaml
    # for explanation
