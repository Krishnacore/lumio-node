---
id: docker_compose
title: Lumio Docker-Compose Configuration
custom_edit_url: https://github.com/lumio/lumio/edit/main/docker/compose/README.md
---
...
If you would like to clear the validator/blockchain data and start from scratch, either remove the docker volume `lumio-shared`,
or run `docker-compose run validator rm -rf '/opt/lumio/var/*'` from the **validator-testnet** directory.

To clear just the validator logs, run  `docker-compose run validator rm -rf '/opt/lumio/var/validator.log'`
