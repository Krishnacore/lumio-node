...
COPY --link --from=tools-builder /aptos/testsuite/forge/src/backend/k8s/helm-values/lumio-node-default-values.yaml /aptos/terraform/lumio-node-default-values.yaml
