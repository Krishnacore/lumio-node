...
use anyhow::anyhow;
use lumio_config::config::{NodeConfig, DEFAULT_EXECUTION_CONCURRENCY_LEVEL};
#[cfg(unix)]
...
pub fn set_lumio_vm_configurations(node_config: &NodeConfig) {
    ...
    LumioVM::set_concurrency_level_once(effective_concurrency_level as usize);
    LumioVM::set_discard_failed_blocks(node_config.execution.discard_failed_blocks);
    LumioVM::set_num_proof_reading_threads_once(
