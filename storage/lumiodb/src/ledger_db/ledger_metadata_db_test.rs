...
use crate::{ledger_db::ledger_metadata_db::LedgerMetadataDb, LumioDB};
...
fn set_up(path: &impl AsRef<Path>, ledger_infos_with_sigs: &[LedgerInfoWithSignatures]) -> LumioDB {
    let db = LumioDB::new_for_test(path);
    ...
    ledger_infos_with_sigs
        ...
        .collect::<Result<Vec<_>, LumioDbError>>()
        .unwrap();
