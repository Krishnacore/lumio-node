...
use crate::{db_debugger::ShardingConfig, LumioDB};
use lumio_config::config::StorageConfig;
...
impl Cmd {
    pub fn run(self) -> Result<()> {
        ...
        .expect("Failed to open LumioDB");

        println!("LumioDB opened. Kill to exit.");
