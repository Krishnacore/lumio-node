...
//! This crate provides [`LumioDB`] which represents physical storage of the core Lumio data
//! structures.
//!
//! It relays read/write operations on the physical storage via `schemadb` to the underlying
//! Key-Value storage system, and implements lumio data structures on top of it.

pub use crate::db::LumioDB;
