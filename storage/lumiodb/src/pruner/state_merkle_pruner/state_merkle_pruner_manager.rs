...
use lumio_config::config::StateMerklePrunerConfig;
use lumio_jellyfish_merkle::StaleNodeIndex;
use lumio_schemadb::schema::KeyCodec;
use lumio_storage_interface::Result;
use lumio_types::transaction::{AtomicVersion, Version};
use std::{
    marker::PhantomData,
    sync::{atomic::Ordering, Arc},
};

/// The `Pruner` is meant to be part of a `LumioDB` instance and runs in the background to prune old
/// data.
///
