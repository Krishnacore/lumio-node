...
//! This module defines representation of Lumio core data structures at physical level via schemas
//! that implement [`lumio_schemadb::schema::Schema`].
//!
...
use lumio_schemadb::ColumnFamilyName;
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use lumio_schemadb::schema::fuzzing::assert_no_panic_decoding;
