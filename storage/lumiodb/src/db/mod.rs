...
use lumio_config::config::{PrunerConfig, RocksdbConfigs, StorageDirPaths};
...
/// access to the core Lumio data structures.
pub struct LumioDB {
...
impl LumioDB {
    ...
    pub fn create_checkpoint(
        ...
        info!(sharding = sharding, "Creating checkpoint for LumioDB.");
