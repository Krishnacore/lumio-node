...
use lumio_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use lumio_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`lumio_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`lumio_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`lumio_types::proof::AccumulatorRangeProof`] for proof format.
