...
pub use lumio_types::indexer::indexer_db_reader::Order;
use lumio_types::{
...
pub use lumio_types::block_info::BlockHeight;
use lumio_types::state_store::state_key::prefix::StateKeyPrefix;
pub use errors::LumioDbError;
pub use ledger_summary::LedgerSummary;

pub type Result<T, E = LumioDbError> = std::result::Result<T, E>;
...
impl From<lumio_secure_net::Error> for Error {
...
pub trait DbReader: Send + Sync {
    ...
    delegate_read!(
        /// See [LumioDB::get_epoch_ending_ledger_infos].
        ///
        /// [LumioDB::get_epoch_ending_ledger_infos]:
        /// ../lumiodb/struct.LumioDB.html#method.get_epoch_ending_ledger_infos
        ...
        /// See [LumioDB::get_transactions].
        ///
        /// [LumioDB::get_transactions]: ../lumiodb/struct.LumioDB.html#method.get_transactions
        fn get_transactions(
            &self,
        ...
        /// See [LumioDB::get_transaction_by_hash].
        ///
        /// [LumioDB::get_transaction_by_hash]: ../lumiodb/struct.LumioDB.html#method.get_transaction_by_hash
        ...
        /// See [LumioDB::get_transaction_by_version].
        ///
        /// [LumioDB::get_transaction_by_version]: ../lumiodb/struct.LumioDB.html#method.get_transaction_by_version
        ...
        /// See [LumioDB::get_persisted_auxiliary_info_iterator].
        ///
        /// [LumioDB::get_persisted_auxiliary_info_iterator]: ../lumiodb/struct.LumioDB.html#method.get_persisted_auxiliary_info_iterator
        ...
        /// See [LumioDB::get_first_txn_version].
        ///
        /// [LumioDB::get_first_txn_version]: ../lumiodb/struct.LumioDB.html#method.get_first_txn_version
        fn get_first_txn_version(&self) -> Result<Option<Version>>;

        /// See [LumioDB::get_first_viable_block].
        ///
        /// [LumioDB::get_first_viable_block]: ../lumiodb/struct.LumioDB.html#method.get_first_viable_block
        fn get_first_viable_block(&self) -> Result<(Version, BlockHeight)>;

        /// See [LumioDB::get_first_write_set_version].
        ///
        /// [LumioDB::get_first_write_set_version]: ../lumiodb/struct.LumioDB.html#method.get_first_write_set_version
        fn get_first_write_set_version(&self) -> Result<Option<Version>>;

        /// See [LumioDB::get_transaction_outputs].
        ///
        /// [LumioDB::get_transaction_outputs]: ../lumiodb/struct.LumioDB.html#method.get_transaction_outputs
        ...
        /// See [LumioDB::get_block_timestamp].
        ///
        /// [LumioDB::get_block_timestamp]:
        /// ../lumiodb/struct.LumioDB.html#method.get_block_timestamp
        fn get_block_timestamp(&self, version: Version) -> Result<u64>;

        /// See `LumioDB::get_latest_block_events`.
        ...
        /// See [LumioDB::get_state_value_by_version].
        ///
        /// [LumioDB::get_state_value_by_version]:
        /// ../lumiodb/struct.LumioDB.html#method.get_state_value_by_version
        ...
        /// See [LumioDB::get_state_value_with_version_by_version].
        ///
        /// [LumioDB::get_state_value_with_version_by_version]:
        /// ../lumiodb/struct.LumioDB.html#method.get_state_value_with_version_by_version
        ...
        /// See [LumioDB::get_account_state_with_proof_by_version].
        ///
        /// [LumioDB::get_account_state_with_proof_by_version]:
        /// ../lumiodb/struct.LumioDB.html#method.get_account_state_with_proof_by_version
        ///
        /// This is used by lumio core (executor) internally.
    ...
    fn get_latest_ledger_info(&self) -> Result<LedgerInfoWithSignatures> {
        self.get_latest_ledger_info_option().and_then(|opt| {
            opt.ok_or_else(|| LumioDbError::Other("Latest LedgerInfo not found.".to_string()))
        })
    }
    ...
    fn ensure_synced_version(&self) -> Result<Version> {
        self.get_synced_version()?
            .ok_or_else(|| LumioDbError::NotFound("Synced version not found.".to_string()))
    }
    ...
    fn ensure_pre_committed_version(&self) -> Result<Version> {
        self.get_pre_committed_version()?
            .ok_or_else(|| LumioDbError::NotFound("Pre-committed version not found.".to_string()))
    }
}

/// Trait that is implemented by a DB that supports certain public (to client) write APIs
/// expected of an Lumio DB. This adds write APIs to DbReader.
#[allow(unused_variables)]
...
macro_rules! db_not_found_bail {
    ($($arg:tt)*) => {
        return Err(LumioDbError::NotFound(format!($($arg)*)))
    };
}
...
macro_rules! db_other_bail {
    ($($arg:tt)*) => {
        return Err(LumioDbError::Other(format!($($arg)*)))
    };
}
