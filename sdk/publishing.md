...
6. Create a git tag `git tag lumio-sdk-v0.0.X HEAD` and push that tag to the lumio-labs/lumio-core repository.

Here is the set of currently published packages that make up the lumio-sdk:
* move-core-types
* lumio-crypto-derive
* lumio-crypto
* lumio-types
* lumio-json-rpc-types
* lumio-client
* lumio-sdk
