...
/// Builds and returns all Lumio native functions.
pub fn lumio_natives_with_builder(
    ...
    lumio_move_stdlib::natives::all_natives(CORE_CODE_ADDRESS, builder)
        .into_iter()
        ...
        .chain(lumio_framework::natives::all_natives(
            CORE_CODE_ADDRESS,
            builder,
            inject_create_signer_for_gov_sim,
        ))
        .chain(lumio_table_natives::table_natives(
            CORE_CODE_ADDRESS,
            builder,
        ))
        .collect()
