...
pub use lumio_gas_schedule::LATEST_GAS_FEATURE_VERSION;
...
/// Returns [TypeBuilder] used by the Lumio blockchain in production.
pub fn lumio_prod_ty_builder(
    gas_feature_version: u64,
    gas_params: &LumioGasParameters,
) -> TypeBuilder {
...
pub fn lumio_default_ty_builder() -> TypeBuilder {
    TypeBuilder::with_limits(128, 20)
}

/// Returns [DeserializerConfig] used by the Lumio blockchain in production.
pub fn lumio_prod_deserializer_config(features: &Features) -> DeserializerConfig {
...
/// Returns [VerifierConfig] used by the Lumio blockchain in production.
pub fn lumio_prod_verifier_config(gas_feature_version: u64, features: &Features) -> VerifierConfig {
...
/// Returns [VMConfig] used by the Lumio blockchain in production, based on the set of feature
/// flags.
pub fn lumio_prod_vm_config(
    gas_feature_version: u64,
    features: &Features,
    ...
    let deserializer_config = lumio_prod_deserializer_config(features);
    let verifier_config = lumio_prod_verifier_config(gas_feature_version, features);
