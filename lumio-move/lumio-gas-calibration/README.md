---
id: lumio-gas-calibration
title: Lumio Automated Gas Calibration
---

## Lumio Automated Gas Calibration

The Lumio Automated Gas Calibration is a tool that lets anyone write Move Samples (or also Move IR) to calibrate the gas parameters for Native Functions (and also Move bytecode instructions). 
...
mkdir MY-PROJECT
cd MY-PROJECT
cargo run -p lumio -- move init --name MY-PROJECT
```
...
Usage: lumio-gas-calibration [OPTIONS]
