This guide gives some hints to troubleshoot issues when using the prover for specifying the Lumio frameworks.

## Installation

Please refer to the [doc](https://lumio.dev/tools/lumio-cli/install-cli/install-move-prover/).
...
you could use the command `cargo test --release -p lumio-framework -- --skip prover`.


## Specification guide

Please refer to the [Move Prover Book](https://lumio.dev/guides/prover-guides/move-prover)
