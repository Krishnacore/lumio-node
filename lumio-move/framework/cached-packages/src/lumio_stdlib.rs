...
pub use crate::{
    lumio_framework_sdk_builder::*, lumio_token_objects_sdk_builder as lumio_token_objects_stdlib,
    lumio_token_sdk_builder as lumio_token_stdlib,
};
...
pub fn lumio_coin_transfer(to: AccountAddress, amount: u64) -> TransactionPayload {
    coin_transfer(LumioCoinType::type_tag(), to, amount)
}
