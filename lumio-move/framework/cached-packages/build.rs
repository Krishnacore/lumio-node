...
use lumio_framework::ReleaseTarget;
...
fn main() -> Result<()> {
    ...
    if std::env::var("SKIP_FRAMEWORK_BUILD").is_err() {
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("lumio-token").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("lumio-token").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("lumio-framework").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("lumio-framework").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("lumio-stdlib").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("lumio-stdlib").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
