...
<dl>
<dt>
<code>orders: <a href="../../lumio-framework/doc/big_ordered_map.md#0x1_big_ordered_map_BigOrderedMap">big_ordered_map::BigOrderedMap</a>&lt;<b>address</b>, <a href="bulk_order_book_types.md#0x7_bulk_order_book_types_BulkOrder">bulk_order_book_types::BulkOrder</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>order_id_to_address: <a href="../../lumio-framework/doc/big_ordered_map.md#0x1_big_ordered_map_BigOrderedMap">big_ordered_map::BigOrderedMap</a>&lt;<a href="order_book_types.md#0x7_order_book_types_OrderIdType">order_book_types::OrderIdType</a>, <b>address</b>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_single_match_for_taker">get_single_match_for_taker</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    price_time_idx: &<b>mut</b> lumio_experimental::price_time_index::PriceTimeIndex,
...
<pre><code><b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_cancel_active_orders">cancel_active_orders</a>(
    price_time_idx: &<b>mut</b> lumio_experimental::price_time_index::PriceTimeIndex, order: &BulkOrder
) {
...
<pre><code><b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_activate_first_price_levels">activate_first_price_levels</a>(
    price_time_idx: &<b>mut</b> lumio_experimental::price_time_index::PriceTimeIndex, order: &BulkOrder, order_id: OrderIdType
) {
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_reinsert_order">reinsert_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> <a href="../../lumio-framework/doc/account.md#0x1_account">account</a> = reinsert_order.get_account_from_match_details();
    <b>assert</b>!(self.orders.contains(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>), <a href="bulk_order_book.md#0x7_bulk_order_book_EORDER_NOT_FOUND">EORDER_NOT_FOUND</a>);
    <b>let</b> order = self.orders.remove(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>);
    ...
    self.orders.add(<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>, order);
}
</code></pre>
...
- <code>self</code>: Mutable reference to the bulk order book
- <code>price_time_idx</code>: Mutable reference to the price time index
- <code><a href="../../lumio-framework/doc/account.md#0x1_account">account</a></code>: The account whose order should be cancelled
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_cancel_bulk_order">cancel_bulk_order</a>(self: &<b>mut</b> <a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>, price_time_idx: &<b>mut</b> <a href="price_time_index.md#0x7_price_time_index_PriceTimeIndex">price_time_index::PriceTimeIndex</a>, <a href="../../lumio-framework/doc/account.md#0x1_account">account</a>: <b>address</b>): (<a href="order_book_types.md#0x7_order_book_types_OrderIdType">order_book_types::OrderIdType</a>, u64, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_cancel_bulk_order">cancel_bulk_order</a>(
    ...
    <b>if</b> (!self.orders.contains(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>)) {
    ...
    // This allows us <b>to</b> reuse the order id for the same <a href="../../lumio-framework/doc/account.md#0x1_account">account</a> in the future without creating a new order.
    <b>let</b> order = self.orders.remove(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_remaining_size">get_remaining_size</a>(self: &<a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>, <a href="../../lumio-framework/doc/account.md#0x1_account">account</a>: <b>address</b>, is_bid: bool): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_remaining_size">get_remaining_size</a>(
    ...
    self.orders.get(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>).destroy_some().get_total_remaining_size(is_bid)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_prices">get_prices</a>(self: &<a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>, <a href="../../lumio-framework/doc/account.md#0x1_account">account</a>: <b>address</b>, is_bid: bool): <a href="../../lumio-framework/../lumio-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_prices">get_prices</a>(
    ...
    self.orders.get(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>).destroy_some().get_all_prices(is_bid)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_sizes">get_sizes</a>(
    ...
    self.orders.get(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>).destroy_some().get_all_sizes(is_bid)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_place_bulk_order">place_bulk_order</a>(
    ...
    <b>let</b> <a href="../../lumio-framework/doc/account.md#0x1_account">account</a> = get_account_from_order_request(&order_req);
    <b>let</b> existing_order = self.orders.contains(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>);
    <b>let</b> order_id = <b>if</b> (existing_order) {
        <b>let</b> old_order = self.orders.remove(&<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>);
        ...
        self.order_id_to_address.add(order_id, <a href="../../lumio-framework/doc/account.md#0x1_account">account</a>);
        order_id
    };
    ...
    self.orders.add(<a href="../../lumio-framework/doc/account.md#0x1_account">account</a>, new_order);
