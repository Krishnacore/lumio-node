#[test_only]
module lumio_experimental::market_single_order_tests {
    use std::option;
    use std::option::Option;
    use std::signer;
    use std::vector;
    use lumio_framework::timestamp;
    use lumio_experimental::event_utils::latest_emitted_events;
    use lumio_experimental::clearinghouse_test;
    use lumio_experimental::clearinghouse_test::{
        test_market_callbacks,
        new_test_order_metadata,
        get_position_size,
    };
    use lumio_experimental::market_test_utils::{
        place_order_and_verify,
        place_taker_order_and_verify_fill,
        place_taker_order,
        verify_cancel_event,
    };
    use lumio_experimental::event_utils;
    use lumio_experimental::market_types::{order_status_open};
    use lumio_experimental::market::{OrderEvent};
    use lumio_experimental::order_book_types::OrderIdType;
    use lumio_experimental::order_book_types::{good_till_cancelled};

    // Import common functions from market_tests
    use lumio_experimental::market_tests_common::{
        setup_market,
        place_maker_order,
        verify_positions,
    ...
    #[test(
       lumio_framework = @0x1, admin = @0x1, market_signer = @0x123, maker1 = @0x456, maker2 = @0x789
    )]
    public fun test_self_matching_allowed(
        ...
        test_self_matching_allowed_helper(lumio_framework, admin, market_signer, maker1, maker2, false);
    }
    ...
    #[test(lumio_framework = @0x1, admin = @0x1, market_signer = @0x123, maker1 = @0x456)]
