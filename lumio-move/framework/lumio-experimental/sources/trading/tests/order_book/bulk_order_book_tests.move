#[test_only]
module lumio_experimental::bulk_order_book_tests {
    use lumio_experimental::order_book_types::{OrderMatch, new_ascending_id_generator, AscendingIdGenerator,
        bulk_order_book_type
    };
    use lumio_experimental::bulk_order_book::{BulkOrderBook, new_bulk_order_book};
    use std::vector;
    use lumio_experimental::bulk_order_book_types::{BulkOrderRequest, new_bulk_order_request};
    use lumio_experimental::price_time_index;
    ...
    #[test]
    #[expected_failure(abort_code = lumio_experimental::bulk_order_book::EORDER_NOT_FOUND)]
    ...
    #[test]
    #[expected_failure(abort_code = lumio_experimental::bulk_order_book_types::EINVLID_MM_ORDER_REQUEST)]
    ...
    #[test]
    #[expected_failure(abort_code = lumio_experimental::bulk_order_book_types::EPRICE_CROSSING)]
