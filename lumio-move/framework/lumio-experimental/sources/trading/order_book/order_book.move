module lumio_experimental::order_book {

    use std::option::Option;
    use lumio_experimental::bulk_order_book::{BulkOrderBook, new_bulk_order_book};
    use lumio_experimental::single_order_book::{SingleOrderBook, new_single_order_book, SingleOrderRequest};
    use lumio_experimental::order_book_types::{AscendingIdGenerator, OrderIdType, new_ascending_id_generator,
        OrderMatch, OrderMatchDetails, single_order_book_type
    };
    use lumio_experimental::single_order_types::{SingleOrder};
    use lumio_experimental::order_book_types::TriggerCondition;
    use lumio_experimental::order_book_types::TimeInForce;
    use lumio_experimental::price_time_index::{PriceTimeIndex, new_price_time_idx};
    ...
    public fun place_bulk_order<M: store + copy + drop>(
        self: &mut OrderBook<M>, order_req: lumio_experimental::bulk_order_book_types::BulkOrderRequest
    ) : OrderIdType {
