...
/// SDK: [`lumio-python-sdk`](https://github.com/lumio-labs/lumio-python-sdk/blob/main/lumio_sdk/package_publisher.py).
///
/// Lumio CLI supports this as well with `--chunked-publish` flag:
/// - `lumio move publish [OPTIONS] --chunked-publish`
/// - `lumio move create-object-and-publish-package [OPTIONS] --address-name <ADDRESS_NAME> --chunked-publish`
/// - `lumio move upgrade-object-package [OPTIONS] --address-name <ADDRESS_NAME> --chunked-publish`
///
/// # Usage
///
/// 1. **Stage Code Chunks**:
...
module lumio_experimental::large_packages {
    use std::error;
    use std::signer;
    use std::vector;
    use lumio_std::smart_table::{Self, SmartTable};

    use lumio_framework::code::{Self, PackageRegistry};
    use lumio_framework::object::{Object};
    use lumio_framework::object_code_deployment;
