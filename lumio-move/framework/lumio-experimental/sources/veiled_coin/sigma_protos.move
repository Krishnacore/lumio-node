...
module lumio_experimental::sigma_protos {
    use std::error;
    ...
    use lumio_std::ristretto255::{Self, RistrettoPoint, Scalar};

    use lumio_experimental::helpers::cut_vector;
    ...
    const FIAT_SHAMIR_SIGMA_DST: vector<u8> = b"LumioVeiledCoin/WithdrawalSubproofFiatShamir";
