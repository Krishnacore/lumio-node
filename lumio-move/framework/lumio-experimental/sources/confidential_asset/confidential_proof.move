...
module lumio_experimental::confidential_proof {
    use std::error;
    use std::option;
    use std::option::Option;
    use std::vector;
    use lumio_std::ristretto255::{Self, CompressedRistretto, Scalar};
    use lumio_std::ristretto255_bulletproofs::{Self as bulletproofs, RangeProof};

    use lumio_experimental::confidential_balance;
    use lumio_experimental::ristretto255_twisted_elgamal as twisted_elgamal;

    friend lumio_experimental::confidential_asset;
    ...
    const FIAT_SHAMIR_WITHDRAWAL_SIGMA_DST: vector<u8> = b"LumioConfidentialAsset/WithdrawalProofFiatShamir";
    const FIAT_SHAMIR_TRANSFER_SIGMA_DST: vector<u8> = b"LumioConfidentialAsset/TransferProofFiatShamir";
    const FIAT_SHAMIR_ROTATION_SIGMA_DST: vector<u8> = b"LumioConfidentialAsset/RotationProofFiatShamir";
    const FIAT_SHAMIR_NORMALIZATION_SIGMA_DST: vector<u8> = b"LumioConfidentialAsset/NormalizationProofFiatShamir";

    const BULLETPROOFS_DST: vector<u8> = b"LumioConfidentialAsset/BulletproofRangeProof";
