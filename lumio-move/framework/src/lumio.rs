...
impl ReleaseTarget {
    ...
    pub fn packages(self) -> Vec<(&'static str, Option<&'static str>, bool)> {
        let result = vec![
            ...
            ("lumio-stdlib", None, false),
            (
                "lumio-framework",
                Some("cached-packages/src/lumio_framework_sdk_builder.rs"),
                false,
            ),
            (
                "lumio-token",
                Some("cached-packages/src/lumio_token_sdk_builder.rs"),
                false,
            ),
            (
                "lumio-token-objects",
                Some("cached-packages/src/lumio_token_objects_sdk_builder.rs"),
                false,
            ),
            ("lumio-experimental", None, true),
        ];
...
static NAMED_ADDRESSES: Lazy<BTreeMap<String, NumericalAddress>> = Lazy::new(|| {
    ...
    result.insert("lumio_std".to_owned(), one);
    result.insert("lumio_framework".to_owned(), one);
    result.insert("lumio_token".to_owned(), three);
    result.insert("lumio_token_objects".to_owned(), four);
    result.insert("lumio_experimental".to_owned(), seven);
    result.insert("lumio_fungible_asset".to_owned(), ten);
