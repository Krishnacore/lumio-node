...
use lumio_framework::{ReleaseOptions, ReleaseTarget};
use clap::Parser;

#[derive(Parser)]
#[clap(name = "lumio-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an Lumio framework release for the specified target.
