...
module raffle::raffle {
    ...
    /// The minimum price of a raffle ticket, in LUM.
    ...
    struct Raffle has key {
        ...
        // See [AIP-41](https://github.com/lumio-foundation/AIPs/blob/main/aips/aip-41.md#undergasing-attacks).
    ...
    public entry fun buy_a_ticket(user: &signer) acquires Raffle {
        ...
        let coins = coin::withdraw<LumioCoin>(user, TICKET_PRICE);
    ...
    /// [AIP-41](https://github.com/lumio-foundation/AIPs/blob/main/aips/aip-41.md)).
    ...
    /// **test-and-abort** attacks (see [AIP-41](https://github.com/lumio-foundation/AIPs/blob/main/aips/aip-41.md)).
    ///
    ...
    public(friend) fun randomly_pick_winner_internal(): address acquires Raffle {
        ...
        coin::deposit<LumioCoin>(winner, coins);
