script {
    ...
    fun main(attacker: &signer) {
        ...
        let old_balance = coin::balance<lumio_coin::LumioCoin>(attacker_addr);
        ...
        //    |- /tmp/lumio-core/lumio-move/move-examples/raffle/scripts/test_and_abort_attack_defeated.move:19:9
        //    |
        ...
        //    |
        //    |- /tmp/lumio-core/lumio-move/move-examples/raffle/sources/raffle.move:122:15
        //    |
        ...
        let new_balance = coin::balance<lumio_coin::LumioCoin>(attacker_addr);
