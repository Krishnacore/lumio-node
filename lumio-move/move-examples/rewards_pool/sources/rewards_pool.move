...
module rewards_pool::rewards_pool {
    use lumio_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata};
    use lumio_framework::primary_fungible_store;
    use lumio_framework::object::{Self, Object, ExtendRef};
    use lumio_std::pool_u64_unbound::{Self as pool_u64, Pool};
    use lumio_std::simple_map::{Self, SimpleMap};
