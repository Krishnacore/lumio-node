...
module stablecoin::usdk {
    ...
    use lumio_framework::function_info;
    use lumio_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleAsset, FungibleStore};
    use lumio_framework::object::{Self, Object, ExtendRef};
    ...
    /// Caller needs to provide the from account's scheme and public key which can be gotten via the Lumio SDK.
