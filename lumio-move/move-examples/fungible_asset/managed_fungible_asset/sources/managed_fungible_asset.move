...
module example_addr::managed_fungible_asset {
    use lumio_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    use lumio_framework::object::{Self, Object, ConstructorRef};
    ...
    fun create_test_mfa(creator: &signer): Object<Metadata> {
        let constructor_ref = &object::create_named_object(creator, b"LUM");
        initialize(
            constructor_ref,
            0,
            utf8(b"Lumio Token"), /* name */
            utf8(b"LUM"), /* symbol */
            8, /* decimals */
