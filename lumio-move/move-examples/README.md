...
1. Clone this repo by running `git clone https://github.com/lumio-labs/lumio-core.git`
2. Open a new terminal and navigate to this folder by running `cd lumio-move/move-examples`
3. Navigate into the specific tutorial you are interested (ex. `cd hello_blockchain`)
4. You can use the Lumio CLI to compile, test, publish, and run these contracts by using the commands outlined here: https://lumio.dev/move/move-on-lumio/cli/
     - If you need to install the Lumio CLI, you can follow these instructions: https://lumio.dev/tools/lumio-cli/install-cli/
...
-  [Lumio Learn](https://learn.lumiolabs.com/code-examples/) provides more step-by-step guides on some high-quality examples. 
- We also have another repo [move-by-examples](https://github.com/lumio-labs/move-by-examples). It has more newer examples and is actively maintained.
