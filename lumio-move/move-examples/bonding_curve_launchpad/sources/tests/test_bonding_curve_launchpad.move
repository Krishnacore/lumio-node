...
module bonding_curve_launchpad::test_bonding_curve_launchpad {
    use lumio_std::string;
    use lumio_std::signer;
    ...
    fun test_setup_accounts(
        lumio_framework: &signer, _swap_dex_signer: &signer, bonding_curve_creator: &signer
    ) {
        ...
        coin::register<LumioCoin>(bonding_curve_creator);
    ...
    #[test(deployer = @bonding_curve_launchpad)]
    #[expected_failure(abort_code = 393218, location = lumio_framework::object)]
    ...
    fun test_e2e_bonding_curve_creation(
        ...
        test_setup_accounts(lumio_framework, swap_dex_signer, bonding_curve_creator);
    ...
    fun test_e2e_swap_after_graduation(
        ...
        test_e2e_graduation(lumio_framework, swap_dex_signer, bcl_owner_signer, bonding_curve_creator);
        let fa_obj_metadata =
