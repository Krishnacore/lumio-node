module bonding_curve_launchpad::liquidity_pairs {
    ...
    use lumio_framework::fungible_asset;
    use lumio_framework::fungible_asset::{Metadata, TransferRef, FungibleAsset, FungibleStore};
    ...
    fun graduate(
        ...
        router::create_pool_coin<LumioCoin>(fa_object_metadata, false);
        let liquidity_pair_signer = object::generate_signer_for_extending(&liquidity_pair.extend_ref);
        add_liquidity_coin_entry_transfer_ref<LumioCoin>(
            transfer_ref,
            &liquidity_pair_signer,
