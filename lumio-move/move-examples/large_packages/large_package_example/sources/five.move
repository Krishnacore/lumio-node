...
///
/// # Integrate with the Lumio Blockchain
///
/// If you provide blockchain services to your customers and wish to add the Lumio blockchain to your platform, then this guide is for you. This system integrators guide will walk you through all you need to integrate the Lumio blockchain into your platform.
///
/// ## Overview
///
/// This document will guide you through the following tasks to integrate with Lumio:
...
/// ### Choose a network
///
/// There are four well-supported networks for integrating with the Lumio blockchain:
///
...
/// * Directly [run a localnet](../nodes/local-testnet/run-a-local-testnet.md) using either the [Lumio-core source code](../nodes/local-testnet/run-a-local-testnet.md#using-the-lumio-core-source-code) or a [Docker image](../nodes/local-testnet/run-a-local-testnet.md#using-docker). These paths are useful for testing changes to the Lumio-core codebase or framework, or for building services on top of the Lumio blockchain, respectively.
/// * [Install the Lumio CLI](../tools/install-cli/index.md) and 2) start a [local node with a faucet](../nodes/local-testnet/using-cli-to-run-a-local-testnet.md#starting-a-local-testnet-with-a-faucet). This path is useful for developing on the Lumio blockchain, debugging Move contracts, and testing node operations.
///
/// Either of these methods will expose a [REST API service](../integration/fullnode-rest-api.md) at `http://127.0.0.1:8080` and a Faucet API service at `http://127.0.0.1:8000` for option 1 run a localnet or `http://127.0.0.1:8081` for option 2 install the Lumio CLI. The applications will output the location of the services.
///
...
///     <ul>
///       <li>REST API: <a href="https://fullnode.devnet.lumiolabs.com/v1">https://fullnode.devnet.lumiolabs.com/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.devnet.lumiolabs.com/v1/spec#/">https://fullnode.devnet.lumiolabs.com/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://api.devnet.lumiolabs.com/v1/graphql">https://api.devnet.lumiolabs.com/v1/graphql</a></li>
///       <li>Faucet API: <a href="https://faucet.devnet.lumiolabs.com">https://faucet.devnet.lumiolabs.com</a></li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://api.devnet.lumiolabs.com/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
...
/// ### SDKs and tools
///
/// Lumio currently provides three SDKs:
/// 1. [Typescript](../sdks/ts-sdk/index.md)
/// 2. [Python](../sdks/python-sdk.md)
/// 3. [Rust](../sdks/rust-sdk.md)
///
/// Almost all developers will benefit from exploring the CLI. [Using the CLI](../tools/lumio-cli-tool/use-lumio-cli.md) demonstrates how the CLI can be used to which includes creating accounts, transferring coins, and publishing modules.
///
/// ## Accounts on Lumio
///
///
/// At creation, an [Lumio account](https://github.com/lumio-labs/lumio-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/lumio-move/framework/lumio-framework/sources/account.move#L23) contains:
/// * A [resource containing Lumio Coin](https://github.com/lumio-labs/lumio-core/blob/60751b5ed44984178c7163933da3d1b18ad80388/lumio-move/framework/lumio-framework/sources/coin.move#L50) and deposit and withdrawal of coins from that resource.
...
///
/// Read more about [Accounts](../concepts/accounts.md) and [set one up](../tools/lumio-cli-tool/use-lumio-cli#initialize-local-configuration-and-create-an-account).
///
/// ## Transactions
///
///
...
///
/// Lumio supports two methods for constructing transactions:
///
/// - Using the Lumio client libraries to generate native BCS transactions.
...
/// - A script (payload)
///
/// Both [Python](https://github.com/lumio-labs/lumio-core/blob/3973311dac6bb9348bfc81cf983c2a1be11f1b48/ecosystem/python/sdk/lumio_sdk/client.py#L256) and [TypeScript](https://github.com/lumio-labs/lumio-core/blob/3973311dac6bb9348bfc81cf983c2a1be11f1b48/ecosystem/typescript/sdk/src/lumio_client.test.ts#L93) support the generation of transactions that target entry points. This guide points out many of those entry points, such as `lumio_account::transfer` and `lumio_account::create_account`.
///
/// Most basic operations on the Lumio blockchain should be available via entry point calls. While one could submit multiple transactions calling entry points in series, such operations benefit from being called atomically from a single transaction. A script payload transaction can call any public (entry) function defined within any module. Here's an example [Move script](https://github.com/lumio-labs/lumio-core/tree/main/lumio-move/move-examples/scripts/two_by_two_transfer) that uses a MultiAgent transaction to extract funds from two accounts and deposit them into two other accounts. This is a [Python example](https://github.com/lumio-labs/lumio-core/blob/main/ecosystem/python/sdk/examples/transfer-two-by-two.py) that uses the bytecode generated by compiling that script. Currently there is limited support for script payloads in TypeScript.
///
...
///
/// To facilitate evaluation of transactions as well as gas estimation, Lumio supports a simulation API that does not require and should not contain valid signatures on transactions.
///
///
/// Both the [Typescript SDK](https://github.com/lumio-labs/lumio-core/blob/9b85d41ed8ef4a61a9cd64f9de511654fcc02024/ecosystem/typescript/sdk/src/lumio_client.ts#L413) and [Python SDK](https://github.com/lumio-labs/lumio-core/blob/main/ecosystem/python/sdk/examples/simulate-transfer-coin.py) support the simulation API. Note the output and gas used may change based upon the state of the account. For gas estimations, we recommend that the maximum gas amount be larger than the amount quoted by this API.
///
/// ## Viewing current and historical state
///
/// Most integrations into the Lumio blockchain benefit from a holistic and comprehensive overview of the current and historical state of the blockchain. Lumio provides historical transactions, state, and events, all the result of transaction execution.
///
...
///
/// Events and transactions pruning can be disabled via setting the [`enable_ledger_pruner`](https://github.com/lumio-labs/lumio-core/blob/cf0bc2e4031a843cdc0c04e70b3f7cd92666afcf/config/src/config/storage_config.rs#L141) to `false`. This is default behavior in Mainnet. In the near future, Lumio will provide indexers that mitigate the need to directly query from a node.
///
/// The REST API offers querying transactions and events in these ways:
///
/// * [Transactions for an account](https://fullnode.devnet.lumiolabs.com/v1/spec#/operations/get_account_transactions)
/// * [Transactions by version](https://fullnode.devnet.lumiolabs.com/v1/spec#/operations/get_transaction_by_version)
/// * [Events by event handle](https://fullnode.devnet.lumiolabs.com/v1/spec#/operations/get_events_by_event_handle)
///
/// ## Exchanging and tracking coins
///
/// Lumio has a standard [Coin type](https://github.com/lumio-labs/lumio-core/blob/main/lumio-move/framework/lumio-framework/sources/coin.move). Different types of coins can be represented in this type through the use of distinct structs that represent the type parameter or generic for `Coin<T>`.
///
/// Coins are stored within an account under the resource `CoinStore<T>`. At account creation, each user has the resource `CoinStore<0x1::lumio_coin::LumioCoin>` or `CoinStore<LumioCoin>`, for short. Within this resource is the Lumio coin: `Coin<LumioCoin>`.
///
/// ### Transferring coins between users
///
/// Coins can be transferred between users via the [`coin::transfer`](https://github.com/lumio-labs/lumio-core/blob/36a7c00b29a457469264187d8e44070b2d5391fe/lumio-move/framework/lumio-framework/sources/coin.move#L307) function for all coins and [`lumio_account::transfer`](https://github.com/lumio-labs/lumio-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/lumio-move/framework/lumio-framework/sources/lumio_account.move#L18) for Lumio coins. The advantage of the latter function is that it creates the destination account if it does not exist.
///
/// :::caution
...
///
/// The current balance for a `Coin<T>` where `T` is the Lumio coin is available at the account resources URL: `https://{rest_api_server}/accounts/{address}/resource/0x1::coin::CoinStore<0x1::lumio_coin::LumioCoin>`. The balance is stored within `coin::amount`. The resource also contains the total number of deposit and withdraw events, and the `counter` value within `deposit_events` and `withdraw_events`, respectively.
///
/// ```
/// {
///   "type": "0x1::coin::CoinStore<0x1::lumio_coin::LumioCoin>",
///   "data": {
///     "coin": {
///       "value": "3927"
///     },
...
///
/// In Lumio, each transaction is committed as a distinct version to the blockchain. This allows for the convenience of sharing committed transactions by their version number; to do so, query: `https://{rest_server_api}/transactions/by_version/{version}`
///
...
/// :::tip
///
/// When tracking full movement of coins, normally events are sufficient. `0x1::lumio_coin::LumioCoin`, however, requires considering `gas_used` for each transaction sent from the given account since it represents gas in Lumio. To reduce unnecessary overhead, extracting gas fees due to transactions does not emit an event. All transactions for an account can be retrieved from this API: `https://{rest_server_api}/accounts/{address}/transactions`
///
/// :::
///
...
/// 3. A gas fee `2200` of `0x1::lumio_coin::LumioCoin` from the sending account `0x810026ca8291dd88b5b30a1d3ca2edd683d33d06c4a7f7c451d96f6d47bc5e8b`
///
...
/// 2. Gas is always: `0x1::lumio_coin::LumioCoin`
///
...
///
/// This tutorial is for SDK and wallet developers who want to integrate with the [Lumio Faucet](https://github.com/lumio-labs/lumio-core/tree/main/crates/lumio-faucet). If you are a dapp developer, you should access the faucet through an existing [SDK](../tutorials/first-transaction.md) or [CLI](../tools/lumio-cli-tool/use-lumio-cli#initialize-local-configuration-and-create-an-account) instead.
///
...
/// - Devnet: https://faucet.devnet.lumiolabs.com
/// - Testnet: https://faucet.testnet.lumiolabs.com
///
/// ### Calling the faucet: JavaScript / TypeScript
/// If you are building a client in JavaScript or TypeScript, you should make use of the [@lumio-labs/lumio-faucet-client](https://www.npmjs.com/package/@lumio-labs/lumio-faucet-client) package. This client is generated based on the OpenAPI spec published by the faucet service.
///
/// Example use:
/// ```typescript
/// import {
///   LumioFaucetClient,
///   FundRequest,
/// } from "@lumio-labs/lumio-faucet-client";
///
/// async function callFaucet(amount: number, address: string): Promise<string[]> {
///   const faucetClient = new LumioFaucetClient({BASE: "https://faucet.devnet.lumiolabs.com"});
...
/// 1. Generate a client from the [OpenAPI spec](https://github.com/lumio-labs/lumio-core/blob/main/crates/lumio-faucet/doc/spec.yaml).
/// 2. Call the faucet on your own.
///
/// For the latter, you will want to build a query similar to this:
/// ```
/// curl -X POST 'https://faucet.devnet.lumiolabs.com/mint?amount=10000&address=0xd0f523c9e73e6f3d68c16ae883a9febc616e484c4998a72d8899a1009e5a89d6'
/// ```
///
