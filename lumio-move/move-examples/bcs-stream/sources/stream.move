...
/// - Exception: For the `deserialize_address` function, the function-based approach from `lumio_std::from_bcs` is used
...
module bcs_stream::bcs_stream {
    ...
    /// This function utilizes the `to_address` function from the `lumio_std::from_bcs` module,
