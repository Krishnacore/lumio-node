...
use lumio_types::state_store::StateView;
use lumio_vm::data_cache::get_resource_group_member_from_metadata;
...
pub struct LumioValueAnnotator<'a, S>(MoveValueAnnotator<ModuleView<'a, S>>);

impl<'a, S: StateView> LumioValueAnnotator<'a, S> {
