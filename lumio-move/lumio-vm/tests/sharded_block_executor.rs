...
/// lumio-vm and lumio-language-e2e-tests, which causes static variables to have two instances in
...
mod test_utils {
    ...
    use lumio_block_partitioner::BlockPartitioner;
    use lumio_keygen::KeyGen;
    use lumio_language_e2e_tests::common_transactions::peer_to_peer_txn;
    ...
    pub fn test_sharded_block_executor_no_conflict<E: ExecutorClient<InMemoryStateStore>>(
        ...
        let unsharded_txn_output = LumioVMBlockExecutor::new()
