...
use lumio_vm_logging::{flush_speculative_logs, init_speculative_logs};
use lumio_vm_types::{
...
use vm_wrapper::LumioExecutorTask;
...
impl BlockExecutorTransactionOutput for LumioTransactionOutput {
...
pub struct LumioBlockExecutorWrapper<
    E: ExecutorTask<
        Txn = SignatureVerifiedTransaction,
        Error = VMStatus,
        Output = LumioTransactionOutput,
    >,
> {
...
impl<
        E: ExecutorTask<
            ...
            Output = LumioTransactionOutput,
        >,
    > LumioBlockExecutorWrapper<E>
{
    pub fn execute_block_on_thread_pool<
        S: StateView + Sync,
        L: TransactionCommitHook<Output = LumioTransactionOutput>,
...
// Same as LumioBlockExecutorWrapper with LumioExecutorTask
pub type LumioVMBlockExecutorWrapper = LumioBlockExecutorWrapper<LumioExecutorTask>;
