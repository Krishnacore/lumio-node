...
use crate::{
    block_executor::LumioVMBlockExecutorWrapper,
...
use lumio_block_executor::{
    code_cache_global_manager::LumioModuleCacheManager, txn_provider::default::DefaultTxnProvider,
};
use lumio_logger::{info, trace};
...
use lumio_vm_logging::disable_speculative_logging;
    ...
    pub fn execute_transactions_with_dependencies(
        ...
        executor_thread_pool.clone().scope(|s| {
            ...
            s.spawn(move |_| {
                ...
                let ret = LumioVMBlockExecutorWrapper::execute_block_on_thread_pool(
                    executor_thread_pool,
                    &txn_provider,
