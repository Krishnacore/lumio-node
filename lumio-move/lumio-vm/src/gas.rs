...
use crate::{move_vm_ext::LumioMoveResolver, transaction_metadata::TransactionMetadata};
use lumio_gas_algebra::{Gas, GasExpression, InternalGas};
use lumio_gas_meter::{StandardGasAlgebra, StandardGasMeter};
use lumio_gas_schedule::{
    gas_feature_versions::RELEASE_V1_13, gas_params::txn::KEYLESS_BASE_COST, LumioGasParameters,
    VMGasParameters,
};
use lumio_logger::{enabled, Level};
use lumio_memory_usage_tracker::MemoryTrackedGasMeter;
use lumio_types::on_chain_config::Features;
use lumio_vm_logging::{log_schema::AdapterLogSchema, speculative_log, speculative_warn};
use lumio_vm_types::{
...
pub(crate) fn check_gas(
    ...
    if crate::lumio_vm::should_create_account_resource(
        txn_metadata,
        features,
        resolver,
        module_storage,
