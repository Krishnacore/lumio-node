...
#[cfg(feature = "testing")]
use lumio_aggregator::resolver::TAggregatorV1View;
#[cfg(feature = "testing")]
use lumio_aggregator::{bounded_math::SignedU128, types::DelayedFieldsSpeculativeError};
#[cfg(feature = "testing")]
use lumio_aggregator::{resolver::TDelayedFieldView, types::DelayedFieldValue};
#[cfg(feature = "testing")]
use lumio_framework::natives::randomness::RandomnessContext;
#[cfg(feature = "testing")]
use lumio_framework::natives::{cryptography::algebra::AlgebraContext, event::NativeEventContext};
use lumio_gas_schedule::{MiscGasParameters, NativeGasParameters, LATEST_GAS_FEATURE_VERSION};
use lumio_native_interface::SafeNativeBuilder;
#[cfg(feature = "testing")]
use lumio_table_natives::{TableHandle, TableResolver};
use lumio_types::on_chain_config::{Features, TimedFeatures, TimedFeaturesBuilder};
#[cfg(feature = "testing")]
use lumio_types::{
    chain_id::ChainId,
...
use lumio_vm_environment::natives::lumio_natives_with_builder;
#[cfg(feature = "testing")]
use bytes::Bytes;
#[cfg(feature = "testing")]
...
#[cfg(feature = "testing")]
struct LumioBlankStorage;

#[cfg(feature = "testing")]
impl LumioBlankStorage {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[cfg(feature = "testing")]
impl TAggregatorV1View for LumioBlankStorage {
...
#[cfg(feature = "testing")]
impl TDelayedFieldView for LumioBlankStorage {
...
#[cfg(feature = "testing")]
impl TableResolver for LumioBlankStorage {
...
static DUMMY_RESOLVER: Lazy<LumioBlankStorage> = Lazy::new(|| LumioBlankStorage::new());

pub fn lumio_natives(
    ...
    lumio_natives_with_builder(&mut builder, false)
}
...
fn unit_test_extensions_hook(exts: &mut NativeContextExtensions) {
    use lumio_framework::natives::object::NativeObjectContext;
    use lumio_table_natives::NativeTableContext;
