...
use crate::{
    ...
    move_vm_ext::{
        resource_state_key, write_op_converter::WriteOpConverter, LumioMoveResolver, SessionId,
    },
};
use lumio_framework::natives::{
...
use lumio_table_natives::{NativeTableContext, TableChangeSet};
use lumio_types::{
