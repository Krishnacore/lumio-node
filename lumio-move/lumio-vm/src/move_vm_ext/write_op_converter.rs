...
use crate::move_vm_ext::{session::BytesWithResourceLayout, LumioMoveResolver};
use lumio_aggregator::delta_change_set::serialize;
use lumio_types::{
...
pub(crate) struct WriteOpConverter<'r> {
    remote: &'r dyn LumioMoveResolver,
...
mod tests {
    ...
    use lumio_vm_types::{
        module_and_script_storage::AsLumioCodeStorage,
    ...
    // TODO: Can re-use some of these testing definitions with lumio-vm-types.
