...
use crate::move_vm_ext::{LumioMoveResolver, SessionExt, SessionId};
...
use lumio_vm_environment::{
    environment::LumioEnvironment,
    natives::lumio_natives_with_builder,
    prod_configs::{lumio_default_ty_builder, lumio_prod_vm_config},
};
use lumio_vm_types::storage::change_set_configs::ChangeSetConfigs;
...
impl GenesisRuntimeBuilder {
    ...
    pub fn new(chain_id: ChainId) -> Self {
        ...
        let vm_config = lumio_prod_vm_config(
        ...
        let natives = lumio_natives_with_builder(&mut native_builder, false);
...
impl GenesisMoveVm {
    ...
    pub fn new_genesis_session<'r, R: LumioMoveResolver>(
        &self,
        resolver: &'r R,
...
pub struct MoveVmExt {
    pub(crate) env: LumioEnvironment,
}

impl MoveVmExt {
    pub fn new(env: &LumioEnvironment) -> Self {
        Self { env: env.clone() }
    }
