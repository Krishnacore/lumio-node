...
//! MoveVM and Session wrapped, to make sure Lumio natives and extensions are always installed and
...
pub use crate::move_vm_ext::{
    resolver::{LumioMoveResolver, AsExecutorView, AsResourceGroupView, ResourceGroupResolver},
...
pub use lumio_types::transaction::user_transaction_context::UserTransactionContext;
