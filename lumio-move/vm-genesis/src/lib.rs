...
fn mainnet_genesis_config() -> GenesisConfiguration {
    ...
    GenesisConfiguration {
        ...
        is_test: false,
        min_stake: 1_000_000 * LUMIO_COINS_BASE_WITH_DECIMALS, // 1M LUM
        // 400M LUM
        min_voting_threshold: (400_000_000 * LUMIO_COINS_BASE_WITH_DECIMALS as u128),
        max_stake: 50_000_000 * LUMIO_COINS_BASE_WITH_DECIMALS, // 50M LUM.
        recurring_lockup_duration_secs: 30 * 24 * 3600,         // 1 month
        required_proposer_stake: 1_000_000 * LUMIO_COINS_BASE_WITH_DECIMALS, // 1M LUM
        rewards_apy_percentage: 10,
