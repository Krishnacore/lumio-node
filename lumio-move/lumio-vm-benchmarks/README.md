---
id: Lumio-vm-benchmarks
title: Lumio VM Benchmarks
---

## Lumio VM Benchmarks

The Lumio VM Benchmark allows anyone to specify a set of Move modules and benchmark 
the running time of transactions in the LumioVM measured in milliseconds. The Lumio
...
```
cd lumio-vm-benchmarks/samples
mkdir proj-name
cd proj-name
cargo run -p lumio -- move init --name proj-name
```
