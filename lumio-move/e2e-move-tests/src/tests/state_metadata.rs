...
fn test_metadata_tracking() {
    ...
    let coin_store = parse_struct_tag("0x1::coin::CoinStore<0x1::lumio_coin::LumioCoin>").unwrap();
    ...
    harness.run_transaction_payload(
        &account1,
        lumio_cached_packages::lumio_stdlib::lumio_account_transfer(address2, 100),
    );
    ...
    harness.run_transaction_payload(
        &account1,
        lumio_cached_packages::lumio_stdlib::lumio_account_transfer(address3, 100),
    );
