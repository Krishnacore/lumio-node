script {
    ...
    use lumio_framework::keyless_account;

    fun main(core_resources: &signer, max_exp_horizon_secs: u64) {
        let fx = lumio_governance::get_signer_testnet_only(core_resources, @lumio_framework);
        ...
        lumio_governance::force_end_epoch_test_only(core_resources);
    }
}
