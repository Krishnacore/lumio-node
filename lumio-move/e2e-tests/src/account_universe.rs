...
//! A model to test properties of common Lumio transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common Lumio
...
pub fn txn_one_account_result(
    ...
    // The transactions set the gas cost to 1 microlumio.
...
pub fn assert_accounts_match(
    ...
    for (idx, account) in universe.accounts().iter().enumerate() {
        ...
        let fungible_store_resource = executor
            .read_lum_fungible_store_resource(account.account())
