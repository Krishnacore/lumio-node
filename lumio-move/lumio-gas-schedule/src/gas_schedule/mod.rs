...
pub use lumio_framework::LumioFrameworkGasParameters;
...
pub mod gas_params {
    ...
    pub mod natives {
        use super::*;
        pub use lumio_framework::gas_params as lumio_framework;
        pub use move_stdlib::gas_params as move_stdlib;
        pub use table::gas_params as table;
    }
}

/// Gas parameters for everything that is needed to run the Lumio blockchain, including
/// instructions, transactions and native functions from various packages.
#[derive(Debug, Clone)]
pub struct LumioGasParameters {
    pub vm: VMGasParameters,
    pub natives: NativeGasParameters,
}

impl FromOnChainGasSchedule for LumioGasParameters {
...
impl ToOnChainGasSchedule for LumioGasParameters {
...
impl InitialGasSchedule for LumioGasParameters {
    fn initial() -> Self {
        Self {
...
pub struct NativeGasParameters {
    ...
    pub lumio_framework: LumioFrameworkGasParameters,
}
...
impl FromOnChainGasSchedule for NativeGasParameters {
    fn from_on_chain_gas_schedule(
        ...
        Ok(Self {
            ...
            lumio_framework: FromOnChainGasSchedule::from_on_chain_gas_schedule(
                gas_schedule,
                feature_version,
            )?,
        })
...
impl NativeGasParameters {
    pub fn zeros() -> Self {
        Self {
            ...
            lumio_framework: LumioFrameworkGasParameters::zeros(),
        }
    }
}
...
impl InitialGasSchedule for NativeGasParameters {
    fn initial() -> Self {
        Self {
            ...
            lumio_framework: InitialGasSchedule::initial(),
        }
    }
}
