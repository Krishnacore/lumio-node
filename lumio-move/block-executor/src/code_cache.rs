...
#[cfg(test)]
use lumio_types::on_chain_config::CurrentTimeMicroseconds;
use lumio_types::{
...
use lumio_vm_types::module_and_script_storage::module_storage::LumioModuleStorage;
#[cfg(test)]
use fail::fail_point;
...
impl<T: Transaction, S: TStateView<Key = T::Key>> LumioModuleStorage for LatestView<'_, T, S> {
...
impl<T: Transaction, S: TStateView<Key = T::Key>> LatestView<'_, T, S> {
    ...
    fn as_module_cache(
        ...
        Verified = Module,
        Extension = LumioModuleExtension,
