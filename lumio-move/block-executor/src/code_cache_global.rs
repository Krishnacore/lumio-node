...
use lumio_types::{
    error::PanicError, transaction::BlockExecutableTransaction, vm::modules::LumioModuleExtension,
    write_set::TransactionWrite,
};
use lumio_vm_types::module_write_set::ModuleWrite;
...
pub(crate) fn add_module_write_to_module_cache<T: BlockExecutableTransaction>(
    ...
    global_module_cache: &GlobalModuleCache<ModuleId, CompiledModule, Module, LumioModuleExtension>,
