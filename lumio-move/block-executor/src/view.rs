...
pub(crate) struct ParallelState<'a, T: Transaction> {
    ...
    pub(crate) captured_reads:
        RefCell<CapturedReads<T, ModuleId, CompiledModule, Module, LumioModuleExtension>>,
}

fn get_delayed_field_value_impl<T: Transaction>(
    captured_reads: &RefCell<
        CapturedReads<T, ModuleId, CompiledModule, Module, LumioModuleExtension>,
    >,
...
mod test {
    ...
    use lumio_vm_types::resolver::TResourceView;
