...
use lumio_types::{
    executable::ModulePath, vm::modules::LumioModuleExtension, write_set::TransactionWrite,
};
...
pub struct MVHashMap<K, T, V: TransactionWrite, I: Clone> {
    ...
    module_cache:
        SyncModuleCache<ModuleId, CompiledModule, Module, LumioModuleExtension, Option<TxnIndex>>,
