...
use anyhow::anyhow;
use lumio_aggregator::types::DelayedFieldValue;
use lumio_types::{
...
use lumio_vm_types::{resolver::ResourceGroupSize, resource_group_adapter::group_size_as_sum};
...
> {
    ...
    module_cache:
        UnsyncModuleCache<ModuleId, CompiledModule, Module, LumioModuleExtension, Option<TxnIndex>>,
    ...
    > UnsyncMap<K, T, V, I>
{
    ...
    fn insert_group_op(
        ...
        use lumio_types::write_set::WriteOpKind::*;
