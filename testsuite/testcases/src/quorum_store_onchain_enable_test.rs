...
use lumio_forge::{NetworkContextSynchronizer, NetworkTest, NodeExt, SwarmExt, Test};
use lumio_sdk::bcs;
use lumio_types::{
...
impl NetworkLoadTest for QuorumStoreOnChainEnableTest {
    async fn test(
        &self,
        swarm: Arc<tokio::sync::RwLock<Box<dyn lumio_forge::Swarm>>>,
        _report: &mut lumio_forge::TestReport,
