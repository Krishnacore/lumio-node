...
use lumio_release_builder::ReleaseConfig;
...
const RELEASE_YAML_PATH: &str = "lumio-move/lumio-release-builder/data";
...
impl NetworkTest for FrameworkUpgrade {
    async fn run<'a>(&self, ctx: NetworkContextSynchronizer<'a>) -> Result<()> {
        ...
        let network_info = lumio_release_builder::validate::NetworkConfig {
            endpoint: ctx
                .swarm
                .read()
                .await
        ...
        let release_config = lumio_release_builder::current_release_config();

        lumio_release_builder::validate::validate_config(
