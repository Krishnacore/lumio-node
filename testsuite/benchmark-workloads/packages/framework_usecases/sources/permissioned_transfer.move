...
module 0xABCD::permissioned_transfer {
    ...
    public entry fun transfer_permissioned(
        ...
        primary_fungible_store::grant_lum_permission(source, &permissioned_signer, amount);
        lumio_account::transfer(&permissioned_signer, to, amount);
    ...
    public entry fun transfer(
        ...
        lumio_account::transfer(source, to, amount);
    }
}
