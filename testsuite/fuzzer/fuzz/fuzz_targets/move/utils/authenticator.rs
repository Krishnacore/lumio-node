...
use lumio_types::keyless::{AnyKeylessPublicKey, EphemeralCertificate};
...
pub(crate) mod miscellaneous {
    use lumio_crypto::{ed25519::ed25519_keys::Ed25519PrivateKey, PrivateKey, Uniform};
    use lumio_types::{
    ...
    impl Default for SampleJwtPayload {
        fn default() -> Self {
            ...
            SampleJwtPayload {
                ...
                hd: "lumiolabs.com".to_string(),
                email: "michael@lumiolabs.com".to_string(),
                email_verified: true,
