...
NODE_CONFIG_MOUNT_NAME: str = "lumio-config"
NODE_CONFIG_MOUNT_PATH: str = "/opt/lumio/etc"
GENESIS_ARTIFACTS_MOUNT_NAME: str = "genesis-config"
GENESIS_ARTIFACTS_MOUNT_PATH: str = "/opt/lumio/genesis"
NODE_IDENTITY_MOUNT_NAME: str = "lumio-secret"
NODE_IDENTITY_MOUNT_PATH: str = "/opt/lumio/identites"
...
DEFAULT_IMAGE: str = "lumiolabs/validator:devnet@sha256:f0c62463b0e86acc9ad081c54be2d1823f143f780c73828b876caebc978c8947"
LUMIO_DATA_NAME: str = "lumio-data"
LUMIO_DATA_DIR: str = "/opt/lumio/data"
...
DEFAULT_TRANSACTION_EMITTER_IMAGE: str = "lumiolabs/tools:devnet"
