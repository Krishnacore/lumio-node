...
//! How and where to record the Serde format of interesting Lumio types.
//! See API documentation with `cargo doc -p serde-reflection --open`

use lumio_crypto::ed25519::{Ed25519PublicKey, Ed25519Signature};
use lumio_types::{
    keyless,
...
impl Corpus {
    ...
    pub fn get_registry(self) -> Registry {
        let result = match self {
            ...
            Corpus::Lumio => lumio::get_registry(),
    ...
    pub fn output_file(self) -> Option<&'static str> {
        match self {
            ...
            Corpus::Lumio => lumio::output_file(),
