...
use lumio::{common::types::GasOptions, test::CliTestFramework};
...
use lumio_forge::{LumioPublicInfo, LocalSwarm, NodeExt, Swarm, SwarmExt};
...
async fn test_keyless_groth16_verifies_using_rust_sdk() {
    ...
    let builder = info
        .transaction_factory()
        .payload(lumio_stdlib::lumio_coin_transfer(recipient.address(), 100));
