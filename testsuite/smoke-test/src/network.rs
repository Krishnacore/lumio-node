...
use lumio_crypto::{encoding_type::EncodingType, x25519, x25519::PrivateKey};
use lumio_forge::{FullNode, Node, NodeExt, Swarm};
...
async fn test_rest_discovery() {
    let mut swarm = SwarmBuilder::new_local(1).with_lumio().build().await;
...
// Currently this test seems flaky: https://github.com/lumio-labs/lumio-core/issues/670
#[ignore]
#[tokio::test]
