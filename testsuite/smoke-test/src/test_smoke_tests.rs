...
/// Previously get_bin triggered a rebuild of lumio-node, which caused issues that were only seen
/// during parallel execution of tests.
/// This test should make regressions obvious.
#[tokio::test]
async fn test_lumio_node_after_get_bin() {
    ...
    // Before #5308 this re-compiled lumio-node and caused a panic on the vfn.
    let _lumio_cli = crate::workspace_builder::get_bin("lumio");
