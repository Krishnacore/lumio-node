...
class Git:
    ...
    def branch_matches_remote(self, remote: str, ref: str) -> bool:
        ...
        # git ls-remote --heads  ssh://git@github.com/pontem-network/lumio-node.git rustielin/exp
    ...
    def get_remote_branches_matching_pattern(
        ...
        """
        Get remote branches that match a specific pattern (e.g. lumio-release-v*).
